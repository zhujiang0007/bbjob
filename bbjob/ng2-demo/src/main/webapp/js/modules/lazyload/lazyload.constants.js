						...
						modules : [
								...
								// uiTree
								{
									...
									files : [
											...
											'vendor/angular-ui-tree/ui.tree.app.css']
								},
								{
									name : 'treeControl',
									files : [
								...
								{
									name: 'text.over',
									files: ['js/modules/server/textOver.directive/textOver.directive.min.js']
								},
								{
									name: 'table.nothing',
								...
								//用户
								{
									...
									files: [
									    	'js/modules/controllers/sys/service/sysuser.service.js',
											'js/modules/controllers/sys/user/sysuser.controller.js'
									       ]
								},
								{
									name: 'userDetail.controller',
									files: ['css/style.userDetail.css',
											'js/modules/controllers/sys/service/sysuserfunction.service.js',
											'js/modules/controllers/sys/service/sysfunction.service.js',
											'js/modules/controllers/sys/service/sysrole.service.js',
											'js/modules/controllers/sys/service/sysuserrole.service.js',
											'js/modules/controllers/sys/service/sysuser.service.js',
											'js/modules/controllers/sys/user/userfunctionpanel.controller.js',
									        'js/modules/controllers/sys/user/userDetail.controller.js'
								...
								//角色
								{
									...
									files: [
										'js/modules/controllers/sys/service/sysrole.service.js',
										'js/modules/controllers/sys/role/sysrole.controller.js'		
									]
								},
								{
									...
									files: [
										'js/modules/controllers/sys/service/sysrole.service.js',
										'js/modules/controllers/sys/service/sysfunction.service.js',
										'js/modules/controllers/sys/service/sysrolefunction.service.js',
										'js/modules/controllers/sys/role/rolefunctionpanel.controller.js',
										'js/modules/controllers/sys/role/sysroleDetail.controller.js'
										]
								},
								//功能管理
								{
								...
								},
								{
									...
									files: ['js/modules/controllers/sys/purview/syspurviewDetail.controller.js']
								}
						]
					});
