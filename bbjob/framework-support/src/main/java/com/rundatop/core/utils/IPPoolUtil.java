...
public class IPPoolUtil {
	...
	{
		System.out.println(getNetMask("255.255.255.128"));
		
		System.out.println(getPoolMax(getNetMask("255.255.255.128")));
		
		System.out.println(getEndIP("10.229.0.255",24).getStartIP());
		
		System.out.println(getEndIP("10.229.0.255",24).getEndIP());
	}
	/**
	 * 根据起始IP地址和子网掩码计算终止IP
	 */
